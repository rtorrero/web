Feature: HANA cluster details
    ...
    Scenario: Cluster sites should have the expected hosts
        ...
        And it should contain host 'vmhdbprd01'
        And the host should have role 'Primary'
        And the hostshould have IPs '10.80.1.11, 10.80.1.13'
        And the Details modal should include the details of the host
        And there should also be an 'WDF' site
        And it should contain host 'vmhdbprd02'
        And the host should have role 'Seconday'
